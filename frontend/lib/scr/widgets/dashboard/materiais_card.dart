    ...
    return Card(
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Coluna da Esquerda (Título e Lista)
            Expanded(
              flex: 3, // Dê mais espaço para a lista
              child: Column(
            ...
            // Espaçador entre a lista e a logo
            const SizedBox(width: 24),

            // Coluna da Direita (Logo)
            Expanded(
              flex: 2, // Ajuste flex se precisar
              child: Center(
                child: Image.asset(
                  'assets/images/logo.jpg', // Caminho da logo
                  height: 200, // <<<<<< LOGO AUMENTADA AQUI
                  fit: BoxFit.contain,
                ),
              ),
            ),
